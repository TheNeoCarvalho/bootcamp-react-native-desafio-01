...
Crie uma aplicação do zero e configure o ESLint, EditorConfig, Reactotron, React DevTools e Babel Module Resolver. Assim que configurados, você deve reproduzir o layout abaixo utilizando FlexBox layout:
